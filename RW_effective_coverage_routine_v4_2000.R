...
setwd("C:/Users/Martin Habimana/Desktop/Data")

#' Set paths to the two mapping files, to the DHS directory and to 
#' the output directory.

dhs_dir    <- "C:/Users/Martin Habimana/Desktop/Data"
hsb_path   <- "C:/Users/Martin Habimana/Desktop/Data/children_access_newvariables_2000.csv"
rx_path    <- "C:/Users/Martin Habimana/Desktop/Data/children_medicines_newvariables_2000.csv"
dhs_file   <- "C:/Users/Martin Habimana/Desktop/Data/RWKR41FL.DTA"
output_dir <- "C:/Users/Martin Habimana/Desktop/Data/eff_cov_output_2000"
...
effective_coverage <- function(access, formal, compl_f, compl_i){
  ...
  cure_act_f         <- 0.972 # #(Therapeutic Efficacy of First line ACT as reported on the Report on antimalarial drug efficacy, resistance and response, 10 years of surveillance (2010–2019))
...
# export to csv
output_path <- file.path(output_dir, "dhs_effcov_allSrvy_v4_2022.csv")
